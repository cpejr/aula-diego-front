            ...
            <div className="CadastroContent">
                ...
                <div className="blocoCadastro">
                    <form>
                        ...
                        <div className="form-group">
                            <input type="password" className="form-control" id="Password1" name="passwordConfirmation"
                                value={
                        ...
                        <div className="form-group">
                            <input type="text" className="form-control" id="Unit" name="unit"
                                ...
                                onChange={handleChange}
                                placeholder="Unidade da Empresa"
                                spellCheck="false"
                                required/>
                        </div>
                        <div className="form-group">
                            <input type="date" placeholder="Data de Nascimento" className="w-100" name="birthdate" 
                            value={
